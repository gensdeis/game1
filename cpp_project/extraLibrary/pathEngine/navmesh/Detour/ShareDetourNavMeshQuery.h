...
#ifndef SHARE_DETOURNAVMESHQUERY_H
#define SHARE_DETOURNAVMESHQUERY_H

#ifndef _SERVER_VERSION
#include "ShareDetourAlloc.h"
#include "ShareDetourNavMesh.h"
#include "ShareDetourCommon.h"
#else
#include "ShareDetourAlloc.h"
#include "ShareDetourNavMesh.h"
#include "ShareDetourCommon.h"
...
{
	//@UE4 BEGIN
#define SHARE_WITH_FIXED_AREA_ENTERING_COST 1

#ifndef _SERVER_VERSION
#define SHARE_DT_UNWALKABLE_POLY_COST _MIRM_FLT_MAX
#else
#define SHARE_DT_UNWALKABLE_POLY_COST LONG_MAX
#endif
//@UE4 END
...
//
	...
	protected:
			...
			const dtPoly* poly) const
		{
			return (poly->flags & data.m_includeFlags) != 0 && (poly->flags & data.m_excludeFlags) == 0
				&& (data.m_areaCost[poly->getArea()] < SHARE_DT_UNWALKABLE_POLY_COST)
#if SHARE_WITH_FIXED_AREA_ENTERING_COST
				&& (data.m_areaFixedCost[poly->getArea()] < SHARE_DT_UNWALKABLE_POLY_COST)
#endif // SHARE_WITH_FIXED_AREA_ENTERING_COST
				;
		}
...
#endif // #if SHARE_WITH_FIXED_AREA_ENTERING_COST
		}
	...
	public:
		...
		///  @param[out]	t			The hit parameter. (_MIRM_FLT_MAX if no wall hit.)
	...
	private:
		...
		dtStatus appendPortals(const int startIdx, const int endIdx, const float* endPos, const std::vector<dtPolyRef>& path,
			dtQueryResult& result, const int options) const;
...
#endif // SHARE_DETOURNAVMESHQUERY_H
