...
#include "ShareDetourTileCacheBuilder.h"
#include "../Detour/ShareDetourCommon.h"
#include "../Detour/ShareDetourAssert.h"
#include "../Detour/ShareDetourAlloc.h"
#else
#include "ShareDetourTileCacheBuilder.h"
#include "../Detour/ShareDetourCommon.h"
#include "../Detour/ShareDetourAssert.h"
		...
		dtTileCachePolyMeshDetail& dmesh)
	{
		...
		for (int i = 0; i < lmesh.npolys; ++i)
		{
			...
			if (dmesh.nverts + nverts > vcap)
			{
				...
				float* nerv = (float*)alloc->alloc(sizeof(float)*vcap * 3);
				if (!nerv)
				{
					return DT_FAILURE | DT_OUT_OF_MEMORY;
				}
