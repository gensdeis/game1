...
namespace mir3d
{
	class mweb_world_boss_statking_board_info_cs : public WebBasePacket 	// gate에서 삭제
	{
	public:
		mpe_governance_contents_type cotents_type{};	// 거버넌스 콘텐츠 타입(0:없음 1:보스 2:비곡점령전 3:공성전)

	public:
		mweb_world_boss_statking_board_info_cs() : WebBasePacket()
		{
		}
	...
	class mweb_world_boss_statking_board_info_sc : public WebBasePacket 	// gate에서 삭제
	{
	private:
	...
	public:
		mweb_world_boss_statking_board_info_sc() : WebBasePacket()
		{
		}
