...
namespace mir3d
{
	class mp_occupationwar_tender_deposit_cs : public BasePacket 
	{
	private:
	...
	public:
		mp_occupationwar_tender_deposit_cs() : BasePacket(mpe_cmd::occupationwar_tender_deposit_cs)
		{
		}
	...
	class mp_occupationwar_tender_deposit_sc : public BasePacket 
	{
	public:
		float weight{};
	private:
		bool flag_info = false;
		mps_item_add info;	// 변경된 아이템
	...
	public:
		mp_occupationwar_tender_deposit_sc() : BasePacket(mpe_cmd::occupationwar_tender_deposit_sc)
		{
		}
