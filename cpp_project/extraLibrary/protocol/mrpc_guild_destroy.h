...
namespace mir3d
{
	class mrpc_guild_destroy_cs : public RpcPacket 
	{
	private:
	...
	public:
		mrpc_guild_destroy_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::guild_destroy_cs, tag)
		{
		}
		mrpc_guild_destroy_cs() : RpcPacket(mpe_rpc_cmd::guild_destroy_cs)
		{
		}
	...
	class mrpc_guild_destroy_sc : public RpcPacket 
	{
	public:
		int64_t key{};
	public:
		bool result{};
	public:
		int64_t next_available_join_time{};	// // 다음 문파 생성 가능 시간
	private:
	...
	public:
		mrpc_guild_destroy_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::guild_destroy_sc, tag)
		{
		}
		mrpc_guild_destroy_sc() : RpcPacket(mpe_rpc_cmd::guild_destroy_sc)
		{
		}
