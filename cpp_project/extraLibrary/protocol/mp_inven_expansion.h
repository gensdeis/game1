...
namespace mir3d
{
	class mp_inven_expansion_cs : public BasePacket 	// //outgame - inventory
	{
	public:
		int32_t expansion_count{};

	public:
		mp_inven_expansion_cs() : BasePacket(mpe_cmd::inven_expansion_cs)
		{
		}
	...
	class mp_inven_expansion_sc : public BasePacket 	// //outgame - inventory
	{
	public:
		int32_t max_size{};
	private:
	...
	public:
		mp_inven_expansion_sc() : BasePacket(mpe_cmd::inven_expansion_sc)
		{
		}
