...
namespace mir3d
{
	class mrpc_recovery_exp_ad_cs : public RpcPacket 	// game->database
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_recovery_exp_ad_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::recovery_exp_ad_cs, tag)
		{
		}
		mrpc_recovery_exp_ad_cs() : RpcPacket(mpe_rpc_cmd::recovery_exp_ad_cs)
		{
		}
	...
	class mrpc_recovery_exp_ad_sc : public RpcPacket 	// game->database
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_recovery_exp_ad_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::recovery_exp_ad_sc, tag)
		{
		}
		mrpc_recovery_exp_ad_sc() : RpcPacket(mpe_rpc_cmd::recovery_exp_ad_sc)
		{
		}
