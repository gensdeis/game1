...
namespace mir3d
{
	class mp_seasonpass_challenge_complet_cs : public BasePacket 
	{
	public:
		bool buy{};	// true : 유료 완료 / false : 진행 완료
	public:
		int32_t challenge_id{};

	public:
		mp_seasonpass_challenge_complet_cs() : BasePacket(mpe_cmd::seasonpass_challenge_complet_cs)
		{
		}
	...
	public:
		template<typename T_BUFFER> void Serialize(T_BUFFER* pBuffer)
		{
			...
			protocol::SerializeType(pBuffer, &buy);
			protocol::SerializeType(pBuffer, &challenge_id);
		}
	...
	class mp_seasonpass_challenge_complet_sc : public BasePacket 
	{
	private:
	...
	public:
		mp_seasonpass_challenge_complet_sc() : BasePacket(mpe_cmd::seasonpass_challenge_complet_sc)
		{
		}
