...
namespace mir3d
{
	class mweb_global_exchange_itemcount_all_cs : public WebBasePacket 
	{
	public:
		mpe_exchange_type type{};

	public:
		mweb_global_exchange_itemcount_all_cs() : WebBasePacket()
		{
		}
	...
	class mweb_global_exchange_itemcount_all_sc : public WebBasePacket 
	{
	private:
	...
	public:
		mweb_global_exchange_itemcount_all_sc() : WebBasePacket()
		{
		}
