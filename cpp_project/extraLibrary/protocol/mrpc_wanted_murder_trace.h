...
namespace mir3d
{
	class mrpc_wanted_murder_trace_cs : public RpcPacket 	// 현상수배 유저 찾기
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_wanted_murder_trace_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::wanted_murder_trace_cs, tag)
		{
		}
		mrpc_wanted_murder_trace_cs() : RpcPacket(mpe_rpc_cmd::wanted_murder_trace_cs)
		{
		}
	...
	class mrpc_wanted_murder_trace_sc : public RpcPacket 	// 현상수배 유저 찾기
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_wanted_murder_trace_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::wanted_murder_trace_sc, tag)
		{
		}
		mrpc_wanted_murder_trace_sc() : RpcPacket(mpe_rpc_cmd::wanted_murder_trace_sc)
		{
		}
