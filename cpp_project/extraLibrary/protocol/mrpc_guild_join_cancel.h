...
namespace mir3d
{
	class mrpc_guild_join_cancel_cs : public RpcPacket 
	{
	private:
	...
	public:
		mrpc_guild_join_cancel_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::guild_join_cancel_cs, tag)
		{
		}
		mrpc_guild_join_cancel_cs() : RpcPacket(mpe_rpc_cmd::guild_join_cancel_cs)
		{
		}
	...
	class mrpc_guild_join_cancel_sc : public RpcPacket 
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_guild_join_cancel_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::guild_join_cancel_sc, tag)
		{
		}
		mrpc_guild_join_cancel_sc() : RpcPacket(mpe_rpc_cmd::guild_join_cancel_sc)
		{
		}
