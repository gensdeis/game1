...
namespace mir3d
{
	class mp_zone_change_enter_cs : public BasePacket 
	{
	public:
		int32_t gate_id{};

	public:
		mp_zone_change_enter_cs() : BasePacket(mpe_cmd::zone_change_enter_cs)
		{
		}
	...
	class mp_zone_change_enter_sc : public BasePacket 
	{
	public:
		int32_t map_id{};
	private:
	...
	public:
		mp_zone_change_enter_sc() : BasePacket(mpe_cmd::zone_change_enter_sc)
		{
		}
