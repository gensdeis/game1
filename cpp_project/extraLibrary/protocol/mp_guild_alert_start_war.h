...
namespace mir3d
{
	class mp_guild_alert_start_war_cs : public BasePacket 	// // 전쟁 선포 알림 패킷
	{

	public:
		mp_guild_alert_start_war_cs() : BasePacket(mpe_cmd::guild_alert_start_war_cs)
		{
		}
	...
	class mp_guild_alert_start_war_sc : public BasePacket 	// // 전쟁 선포 알림 패킷
	{
	private:
		bool flag_war = false;
	...
	public:
		mp_guild_alert_start_war_sc() : BasePacket(mpe_cmd::guild_alert_start_war_sc)
		{
		}
