...
namespace mir3d
{
	class mweb_advertisement_exp_restore_cs : public WebBasePacket 	// 광고 경험치 복구
	{
	public:
		int64_t auid{};
	public:
	...
	public:
		mweb_advertisement_exp_restore_cs() : WebBasePacket()
		{
		}
	...
	class mweb_advertisement_exp_restore_sc : public WebBasePacket 	// 광고 경험치 복구
	{
	public:
		int32_t result{};
	private:
	...
	public:
		mweb_advertisement_exp_restore_sc() : WebBasePacket()
		{
		}
