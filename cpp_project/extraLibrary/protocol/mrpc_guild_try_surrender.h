...
namespace mir3d
{
	class mrpc_guild_try_surrender_cs : public RpcPacket 
	{
	private:
	...
	public:
		mrpc_guild_try_surrender_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::guild_try_surrender_cs, tag)
		{
		}
		mrpc_guild_try_surrender_cs() : RpcPacket(mpe_rpc_cmd::guild_try_surrender_cs)
		{
		}
	...
	class mrpc_guild_try_surrender_sc : public RpcPacket 
	{
	public:
		int64_t key{};
	public:
	...
	public:
		int32_t current_reject_count{};

	public:
		mrpc_guild_try_surrender_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::guild_try_surrender_sc, tag)
		{
		}
		mrpc_guild_try_surrender_sc() : RpcPacket(mpe_rpc_cmd::guild_try_surrender_sc)
		{
		}
