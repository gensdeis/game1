...
namespace mir3d
{
	class mp_gate_game_option_select_cs : public BasePacket 
	{
	public:
		int64_t cuid{};
	public:
	...
	public:
		mp_gate_game_option_select_cs() : BasePacket(mpe_cmd::gate_game_option_select_cs)
		{
		}
	...
	class mp_gate_game_option_select_sc : public BasePacket 
	{
	private:
	...
	public:
		mp_gate_game_option_select_sc() : BasePacket(mpe_cmd::gate_game_option_select_sc)
		{
		}
