...
namespace mir3d
{
	class mrpc_expert_equipment_reinforce_cs : public RpcPacket 
	{
	public:
		int64_t cuid{};	// "캐릭터UID"
	public:
	...
	public:
		mrpc_expert_equipment_reinforce_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::expert_equipment_reinforce_cs, tag)
		{
		}
		mrpc_expert_equipment_reinforce_cs() : RpcPacket(mpe_rpc_cmd::expert_equipment_reinforce_cs)
		{
		}
	...
	class mrpc_expert_equipment_reinforce_sc : public RpcPacket 
	{

	public:
		mrpc_expert_equipment_reinforce_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::expert_equipment_reinforce_sc, tag)
		{
		}
		mrpc_expert_equipment_reinforce_sc() : RpcPacket(mpe_rpc_cmd::expert_equipment_reinforce_sc)
		{
		}
