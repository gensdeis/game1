...
namespace mir3d
{
	class mweb_gm_add_item_cs : public WebBasePacket 
	{
	public:
	...
	public:
		mweb_gm_add_item_cs() : WebBasePacket()
		{
		}
	...
	class mweb_gm_add_item_sc : public WebBasePacket 
	{
	public:
		mpe_error result{};

	public:
		mweb_gm_add_item_sc() : WebBasePacket()
		{
		}
