...
namespace mir3d
{
	class mp_gate_guild_league_rank_cs : public BasePacket 
	{
	public:
	...
	public:
		mp_gate_guild_league_rank_cs() : BasePacket(mpe_cmd::gate_guild_league_rank_cs)
		{
		}
	...
	class mp_gate_guild_league_rank_sc : public BasePacket 
	{
	public:
	...
	public:
		mp_gate_guild_league_rank_sc() : BasePacket(mpe_cmd::gate_guild_league_rank_sc)
		{
		}
