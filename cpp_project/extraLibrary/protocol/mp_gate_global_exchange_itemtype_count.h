...
namespace mir3d
{
	class mp_gate_global_exchange_itemtype_count_cs : public BasePacket 
	{
	public:
	...
	public:
		mp_gate_global_exchange_itemtype_count_cs() : BasePacket(mpe_cmd::gate_global_exchange_itemtype_count_cs)
		{
		}
	...
	class mp_gate_global_exchange_itemtype_count_sc : public BasePacket 
	{
	private:
	...
	public:
		mp_gate_global_exchange_itemtype_count_sc() : BasePacket(mpe_cmd::gate_global_exchange_itemtype_count_sc)
		{
		}
