...
namespace mir3d
{
	class mweb_api_white_list_account_edit_cs : public WebBasePacket 
	{
	private:
	...
	public:
		mweb_api_white_list_account_edit_cs() : WebBasePacket()
		{
		}
	...
	class mweb_api_white_list_account_edit_sc : public WebBasePacket 
	{
	public:
		mpe_error result{};

	public:
		mweb_api_white_list_account_edit_sc() : WebBasePacket()
		{
		}
