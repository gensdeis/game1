...
namespace mir3d
{
	class mrpc_gate_advertisement_info_cs : public RpcPacket 	// 광고 정보
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_gate_advertisement_info_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::gate_advertisement_info_cs, tag)
		{
		}
		mrpc_gate_advertisement_info_cs() : RpcPacket(mpe_rpc_cmd::gate_advertisement_info_cs)
		{
		}
	...
	class mrpc_gate_advertisement_info_sc : public RpcPacket 	// 광고 정보
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_gate_advertisement_info_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::gate_advertisement_info_sc, tag)
		{
		}
		mrpc_gate_advertisement_info_sc() : RpcPacket(mpe_rpc_cmd::gate_advertisement_info_sc)
		{
		}
