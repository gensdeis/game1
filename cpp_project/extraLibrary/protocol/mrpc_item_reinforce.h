...
namespace mir3d
{
	class mrpc_item_reinforce_cs : public RpcPacket 
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_item_reinforce_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::item_reinforce_cs, tag)
		{
		}
		mrpc_item_reinforce_cs() : RpcPacket(mpe_rpc_cmd::item_reinforce_cs)
		{
		}
	...
	class mrpc_item_reinforce_sc : public RpcPacket 
	{
	public:
		int64_t key{};

	public:
		mrpc_item_reinforce_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::item_reinforce_sc, tag)
		{
		}
		mrpc_item_reinforce_sc() : RpcPacket(mpe_rpc_cmd::item_reinforce_sc)
		{
		}
