...
#include "struct/mps_enchant_option_list.h"
#include "struct/mps_profesion.h"

namespace mir3d
{
	class mp_item_enchant_option_make_cs : public BasePacket 
	{
	public:
		int64_t iuid{};
	public:
	...
	public:
		mpe_item_enchant_option_make_flag make_count{};
	public:
		int32_t lock_slot{};
	public:
	...
	public:
		mp_item_enchant_option_make_cs() : BasePacket(mpe_cmd::item_enchant_option_make_cs)
		{
		}
	...
	public:
		template<typename T_BUFFER> void Serialize(T_BUFFER* pBuffer)
		{
			...
			protocol::SerializeEnum(pBuffer, &make_count);
	...
	class mp_item_enchant_option_make_sc : public BasePacket 
	{
	public:
		int64_t iuid{};
	private:
	...
	public:
		mp_item_enchant_option_make_sc() : BasePacket(mpe_cmd::item_enchant_option_make_sc)
		{
		}
