...
namespace mir3d
{
	class mweb_api_guild_info_with_guid_cs : public WebBasePacket 
	{
	public:
		int64_t guid{};

	public:
		mweb_api_guild_info_with_guid_cs() : WebBasePacket()
		{
		}
	...
	class mweb_api_guild_info_with_guid_sc : public WebBasePacket 
	{
	public:
		mpe_error result{};
	private:
	...
	public:
		mweb_api_guild_info_with_guid_sc() : WebBasePacket()
		{
		}
