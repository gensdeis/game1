...
namespace mir3d
{
	class mp_zone_teleport_view_point_cs : public BasePacket 	// 거점 텔레포트
	{
	public:
		int32_t view_point_id{};	// 거점아이디
	public:
		mpe_teleport_type tel_type{};	// 텔레포트타입

	public:
		mp_zone_teleport_view_point_cs() : BasePacket(mpe_cmd::zone_teleport_view_point_cs)
		{
		}
	...
	class mp_zone_teleport_view_point_sc : public BasePacket 	// 거점 텔레포트
	{
	public:
		int32_t map_id{};
	private:
	...
	public:
		mp_zone_teleport_view_point_sc() : BasePacket(mpe_cmd::zone_teleport_view_point_sc)
		{
		}
