...
namespace mir3d
{
	class mp_party_create_cs : public BasePacket 
	{
	private:
	...
	public:
		mp_party_create_cs() : BasePacket(mpe_cmd::party_create_cs)
		{
		}
	...
	class mp_party_create_sc : public BasePacket 
	{
	private:
		bool flag_info = false;
		mps_party_info info;
	...
	public:
		mp_party_create_sc() : BasePacket(mpe_cmd::party_create_sc)
		{
		}
