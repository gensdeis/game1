...
namespace mir3d
{
	class mrpc_governance_unstaking_cs : public RpcPacket 	// 보스거버넌스 언스테이킹
	{
	public:
		int64_t auid{};	// 계정 아이디
	public:
	...
	public:
		mrpc_governance_unstaking_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::governance_unstaking_cs, tag)
		{
		}
		mrpc_governance_unstaking_cs() : RpcPacket(mpe_rpc_cmd::governance_unstaking_cs)
		{
		}
	...
	class mrpc_governance_unstaking_sc : public RpcPacket 	// 보스거버넌스 언스테이킹
	{
	public:
		int64_t auid{};	// 계정 아이디
	public:
	...
	public:
		mrpc_governance_unstaking_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::governance_unstaking_sc, tag)
		{
		}
		mrpc_governance_unstaking_sc() : RpcPacket(mpe_rpc_cmd::governance_unstaking_sc)
		{
		}
