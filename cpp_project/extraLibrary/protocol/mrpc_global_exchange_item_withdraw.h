...
namespace mir3d
{
	class mrpc_global_exchange_item_withdraw_cs : public RpcPacket 
	{
	private:
	...
	public:
		mrpc_global_exchange_item_withdraw_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::global_exchange_item_withdraw_cs, tag)
		{
		}
		mrpc_global_exchange_item_withdraw_cs() : RpcPacket(mpe_rpc_cmd::global_exchange_item_withdraw_cs)
		{
		}
	...
	class mrpc_global_exchange_item_withdraw_sc : public RpcPacket 
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_global_exchange_item_withdraw_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::global_exchange_item_withdraw_sc, tag)
		{
		}
		mrpc_global_exchange_item_withdraw_sc() : RpcPacket(mpe_rpc_cmd::global_exchange_item_withdraw_sc)
		{
		}
