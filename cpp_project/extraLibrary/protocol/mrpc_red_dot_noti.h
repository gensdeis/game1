...
namespace mir3d
{
	class mrpc_red_dot_noti_cs : public RpcPacket 
	{
	public:
		int64_t auid{};
	public:
	...
	public:
		mrpc_red_dot_noti_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::red_dot_noti_cs, tag)
		{
		}
		mrpc_red_dot_noti_cs() : RpcPacket(mpe_rpc_cmd::red_dot_noti_cs)
		{
		}
	...
	class mrpc_red_dot_noti_sc : public RpcPacket 
	{
	public:
		int64_t cuid{};
	public:
	...
	public:
		mrpc_red_dot_noti_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::red_dot_noti_sc, tag)
		{
		}
		mrpc_red_dot_noti_sc() : RpcPacket(mpe_rpc_cmd::red_dot_noti_sc)
		{
		}
