...
namespace mir3d
{
	class mp_friend_teleport_cs : public BasePacket 
	{
	public:
		int32_t map_id{};
	public:
	...
	public:
		mp_friend_teleport_cs() : BasePacket(mpe_cmd::friend_teleport_cs)
		{
		}
	...
	class mp_friend_teleport_sc : public BasePacket 
	{
	public:
		int32_t map_id{};
	private:
	...
	public:
		mp_friend_teleport_sc() : BasePacket(mpe_cmd::friend_teleport_sc)
		{
		}
