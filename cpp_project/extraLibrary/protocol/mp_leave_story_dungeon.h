...
namespace mir3d
{
	class mp_leave_story_dungeon_cs : public BasePacket 	// 스토리 던전 퇴장 패킷 
	{

	public:
		mp_leave_story_dungeon_cs() : BasePacket(mpe_cmd::leave_story_dungeon_cs)
		{
		}
	...
	class mp_leave_story_dungeon_sc : public BasePacket 	// 스토리 던전 퇴장 패킷 
	{
	public:
		int32_t map_id{};
	private:
	...
	public:
		mp_leave_story_dungeon_sc() : BasePacket(mpe_cmd::leave_story_dungeon_sc)
		{
		}
