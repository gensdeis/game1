...
namespace mir3d
{
	class mweb_exchange_itemid_reinforce_list_cs : public WebBasePacket 
	{
	public:
	...
	public:
		mweb_exchange_itemid_reinforce_list_cs() : WebBasePacket()
		{
		}
	...
	class mweb_exchange_itemid_reinforce_list_sc : public WebBasePacket 
	{
	public:
	...
	public:
		mweb_exchange_itemid_reinforce_list_sc() : WebBasePacket()
		{
		}
