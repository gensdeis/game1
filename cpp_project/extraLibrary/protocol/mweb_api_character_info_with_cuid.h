...
namespace mir3d
{
	class mweb_api_character_info_with_cuid_cs : public WebBasePacket 
	{
	public:
		int64_t cuid{};

	public:
		mweb_api_character_info_with_cuid_cs() : WebBasePacket()
		{
		}
	...
	class mweb_api_character_info_with_cuid_sc : public WebBasePacket 
	{
	public:
		mpe_error result{};
	private:
	...
	public:
		mweb_api_character_info_with_cuid_sc() : WebBasePacket()
		{
		}
