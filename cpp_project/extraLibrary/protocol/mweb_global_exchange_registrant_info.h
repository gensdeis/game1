...
namespace mir3d
{
	class mweb_global_exchange_registrant_info_cs : public WebBasePacket 
	{
	public:
		int64_t cuid{};
	public:
	...
	public:
		mweb_global_exchange_registrant_info_cs() : WebBasePacket()
		{
		}
	...
	class mweb_global_exchange_registrant_info_sc : public WebBasePacket 
	{
	private:
	...
	public:
		mweb_global_exchange_registrant_info_sc() : WebBasePacket()
		{
		}
