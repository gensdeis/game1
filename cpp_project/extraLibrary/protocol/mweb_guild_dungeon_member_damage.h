...
namespace mir3d
{
	class mweb_guild_dungeon_member_damage_cs : public WebBasePacket 
	{
	public:
		int64_t guid{};

	public:
		mweb_guild_dungeon_member_damage_cs() : WebBasePacket()
		{
		}
	...
	class mweb_guild_dungeon_member_damage_sc : public WebBasePacket 
	{
	private:
	...
	public:
		mweb_guild_dungeon_member_damage_sc() : WebBasePacket()
		{
		}
