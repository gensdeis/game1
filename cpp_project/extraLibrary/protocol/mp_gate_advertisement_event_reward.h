...
namespace mir3d
{
	class mp_gate_advertisement_event_reward_cs : public BasePacket 	// 광고 출석 보상
	{
	public:
		int64_t auid{};
	public:
	...
	public:
		mp_gate_advertisement_event_reward_cs() : BasePacket(mpe_cmd::gate_advertisement_event_reward_cs)
		{
		}
	...
	class mp_gate_advertisement_event_reward_sc : public BasePacket 	// 광고 출석 보상
	{
	public:
		int32_t result{};
	public:
	...
	public:
		mp_gate_advertisement_event_reward_sc() : BasePacket(mpe_cmd::gate_advertisement_event_reward_sc)
		{
		}
