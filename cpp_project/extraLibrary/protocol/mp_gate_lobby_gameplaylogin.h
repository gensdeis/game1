...
namespace mir3d
{
	class mp_gate_lobby_gameplaylogin_cs : public BasePacket 	// 로비 로그인(gate에서 삭제)
	{
	public:
		int64_t auid{};
	public:
	...
	public:
		mp_gate_lobby_gameplaylogin_cs() : BasePacket(mpe_cmd::gate_lobby_gameplaylogin_cs)
		{
		}
	...
	class mp_gate_lobby_gameplaylogin_sc : public BasePacket 	// 로비 로그인(gate에서 삭제)
	{
	public:
		int32_t result{};
	public:
	...
	public:
		mp_gate_lobby_gameplaylogin_sc() : BasePacket(mpe_cmd::gate_lobby_gameplaylogin_sc)
		{
		}
