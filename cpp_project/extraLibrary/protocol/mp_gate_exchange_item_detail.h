...
namespace mir3d
{
	class mp_gate_exchange_item_detail_cs : public BasePacket 
	{
	public:
	...
	public:
		mp_gate_exchange_item_detail_cs() : BasePacket(mpe_cmd::gate_exchange_item_detail_cs)
		{
		}
	...
	class mp_gate_exchange_item_detail_sc : public BasePacket 
	{
	private:
	...
	public:
		mp_gate_exchange_item_detail_sc() : BasePacket(mpe_cmd::gate_exchange_item_detail_sc)
		{
		}
