...
namespace mir3d
{
	class mp_gate_world_exchange_itemcount_type_cs : public BasePacket 
	{
	public:
		int32_t category_button_type{};

	public:
		mp_gate_world_exchange_itemcount_type_cs() : BasePacket(mpe_cmd::gate_world_exchange_itemcount_type_cs)
		{
		}
	...
	class mp_gate_world_exchange_itemcount_type_sc : public BasePacket 
	{
	private:
	...
	public:
		mp_gate_world_exchange_itemcount_type_sc() : BasePacket(mpe_cmd::gate_world_exchange_itemcount_type_sc)
		{
		}
