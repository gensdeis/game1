...
namespace mir3d
{
	class mrpc_party_enter_request_cs : public RpcPacket 
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_party_enter_request_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::party_enter_request_cs, tag)
		{
		}
		mrpc_party_enter_request_cs() : RpcPacket(mpe_rpc_cmd::party_enter_request_cs)
		{
		}
	...
	class mrpc_party_enter_request_sc : public RpcPacket 
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_party_enter_request_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::party_enter_request_sc, tag)
		{
		}
		mrpc_party_enter_request_sc() : RpcPacket(mpe_rpc_cmd::party_enter_request_sc)
		{
		}
