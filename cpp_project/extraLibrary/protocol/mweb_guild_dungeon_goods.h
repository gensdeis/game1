...
namespace mir3d
{
	class mweb_guild_dungeon_goods_cs : public WebBasePacket 
	{
	public:
		int64_t cuid{};
	public:
	...
	public:
		mweb_guild_dungeon_goods_cs() : WebBasePacket()
		{
		}
	...
	class mweb_guild_dungeon_goods_sc : public WebBasePacket 
	{
	public:
		int32_t result{};
	public:
	...
	public:
		mweb_guild_dungeon_goods_sc() : WebBasePacket()
		{
		}
