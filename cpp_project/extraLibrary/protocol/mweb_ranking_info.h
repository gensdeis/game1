...
namespace mir3d
{
	class mweb_ranking_info_cs : public WebBasePacket 
	{
	public:
		mpe_ranking_type ranking_type{};

	public:
		mweb_ranking_info_cs() : WebBasePacket()
		{
		}
	...
	class mweb_ranking_info_sc : public WebBasePacket 
	{
	public:
		std::vector<mps_ranking_info> ranking_list{};

	public:
		mweb_ranking_info_sc() : WebBasePacket()
		{
		}
