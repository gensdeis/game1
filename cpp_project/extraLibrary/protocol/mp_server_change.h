...
namespace mir3d
{
	class mp_server_change_cs : public BasePacket 
	{
	public:
		int32_t channel{};	// // 서버 채널 이동시

	public:
		mp_server_change_cs() : BasePacket(mpe_cmd::server_change_cs)
		{
		}
	...
	class mp_server_change_sc : public BasePacket 
	{
	public:
		mpe_error result{};	// // 결과
	public:
	...
	public:
		mp_server_change_sc() : BasePacket(mpe_cmd::server_change_sc)
		{
		}
