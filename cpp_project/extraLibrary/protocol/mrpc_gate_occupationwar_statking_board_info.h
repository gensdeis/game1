...
namespace mir3d
{
	class mrpc_gate_occupationwar_statking_board_info_cs : public RpcPacket 
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_gate_occupationwar_statking_board_info_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::gate_occupationwar_statking_board_info_cs, tag)
		{
		}
		mrpc_gate_occupationwar_statking_board_info_cs() : RpcPacket(mpe_rpc_cmd::gate_occupationwar_statking_board_info_cs)
		{
		}
	...
	class mrpc_gate_occupationwar_statking_board_info_sc : public RpcPacket 
	{
	public:
		int64_t key{};
	private:
	...
	public:
		mrpc_gate_occupationwar_statking_board_info_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::gate_occupationwar_statking_board_info_sc, tag)
		{
		}
		mrpc_gate_occupationwar_statking_board_info_sc() : RpcPacket(mpe_rpc_cmd::gate_occupationwar_statking_board_info_sc)
		{
		}
