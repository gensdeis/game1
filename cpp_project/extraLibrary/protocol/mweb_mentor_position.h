...
namespace mir3d
{
	class mweb_mentor_position_cs : public WebBasePacket 
	{
	public:
		int64_t cuid{};

	public:
		mweb_mentor_position_cs() : WebBasePacket()
		{
		}
	...
	class mweb_mentor_position_sc : public WebBasePacket 
	{
	public:
		int64_t cuid{};
	public:
	...
	public:
		mweb_mentor_position_sc() : WebBasePacket()
		{
		}
