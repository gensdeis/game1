...
namespace mir3d
{
	class mp_gate_pre_verify_cs : public BasePacket 
	{
	public:
	...
	public:
		mp_gate_pre_verify_cs() : BasePacket(mpe_cmd::gate_pre_verify_cs)
		{
		}
	...
	class mp_gate_pre_verify_sc : public BasePacket 
	{
	public:
		int32_t code{};
	public:
	...
	public:
		mp_gate_pre_verify_sc() : BasePacket(mpe_cmd::gate_pre_verify_sc)
		{
		}
