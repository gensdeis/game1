...
namespace mir3d
{
	class mweb_api_server_mail_add_cs : public WebBasePacket 
	{
	public:
		int64_t uid{};
	public:
	...
	public:
		mweb_api_server_mail_add_cs() : WebBasePacket()
		{
		}
	...
	class mweb_api_server_mail_add_sc : public WebBasePacket 
	{
	public:
		mpe_error result{};

	public:
		mweb_api_server_mail_add_sc() : WebBasePacket()
		{
		}
