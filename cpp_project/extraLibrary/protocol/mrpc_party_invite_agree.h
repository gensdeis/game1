...
namespace mir3d
{
	class mrpc_party_invite_agree_cs : public RpcPacket 
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_party_invite_agree_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::party_invite_agree_cs, tag)
		{
		}
		mrpc_party_invite_agree_cs() : RpcPacket(mpe_rpc_cmd::party_invite_agree_cs)
		{
		}
	...
	class mrpc_party_invite_agree_sc : public RpcPacket 
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_party_invite_agree_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::party_invite_agree_sc, tag)
		{
		}
		mrpc_party_invite_agree_sc() : RpcPacket(mpe_rpc_cmd::party_invite_agree_sc)
		{
		}
