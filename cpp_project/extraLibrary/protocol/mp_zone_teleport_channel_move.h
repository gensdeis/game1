...
namespace mir3d
{
	class mp_zone_teleport_channel_move_cs : public BasePacket 
	{
	public:
		uint16_t channel_id{};

	public:
		mp_zone_teleport_channel_move_cs() : BasePacket(mpe_cmd::zone_teleport_channel_move_cs)
		{
		}
	...
	class mp_zone_teleport_channel_move_sc : public BasePacket 
	{
	public:
		int32_t map_id{};
	private:
	...
	public:
		mp_zone_teleport_channel_move_sc() : BasePacket(mpe_cmd::zone_teleport_channel_move_sc)
		{
		}
