...
namespace mir3d
{
	class mp_gate_siege_warfare_alliance_receive_list_cs : public BasePacket 	// 연합 리스트 정보 (요청받은길드용)
	{
	public:
		int64_t guid{};
	public:
	...
	public:
		mp_gate_siege_warfare_alliance_receive_list_cs() : BasePacket(mpe_cmd::gate_siege_warfare_alliance_receive_list_cs)
		{
		}
	...
	class mp_gate_siege_warfare_alliance_receive_list_sc : public BasePacket 	// 연합 리스트 정보 (요청받은길드용)
	{
	public:
	...
	public:
		mp_gate_siege_warfare_alliance_receive_list_sc() : BasePacket(mpe_cmd::gate_siege_warfare_alliance_receive_list_sc)
		{
		}
