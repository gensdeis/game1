...
namespace mir3d
{
	class mp_item_use_cs : public BasePacket 
	{
	public:
		int64_t iuid{};
	public:
	...
	public:
		mp_item_use_cs() : BasePacket(mpe_cmd::item_use_cs)
		{
		}
	...
	class mp_item_use_sc : public BasePacket 
	{
	public:
		int64_t iuid{};
	public:
	...
	public:
		mp_item_use_sc() : BasePacket(mpe_cmd::item_use_sc)
		{
		}
