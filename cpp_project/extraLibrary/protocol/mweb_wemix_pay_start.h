...
namespace mir3d
{
	class mweb_wemix_pay_start_cs : public WebBasePacket 	// 위믹스 상점 트랜잭션 hash 발급
	{
	public:
	...
	public:
		mweb_wemix_pay_start_cs() : WebBasePacket()
		{
		}
	...
	class mweb_wemix_pay_start_sc : public WebBasePacket 	// 위믹스 상점 트랜잭션 hash 발급
	{
	public:
		int32_t code{};
	public:
	...
	public:
		mweb_wemix_pay_start_sc() : WebBasePacket()
		{
		}
