...
namespace mir3d
{
	class mweb_world_boss_statking_player_info_cs : public WebBasePacket 
	{
	public:
	...
	public:
		mweb_world_boss_statking_player_info_cs() : WebBasePacket()
		{
		}
	...
	class mweb_world_boss_statking_player_info_sc : public WebBasePacket 
	{
	private:
	...
	public:
		mweb_world_boss_statking_player_info_sc() : WebBasePacket()
		{
		}
