...
namespace mir3d
{
	class mp_slot_upgrade_cs : public BasePacket 
	{
	public:
		uint16_t slot_index{};

	public:
		mp_slot_upgrade_cs() : BasePacket(mpe_cmd::slot_upgrade_cs)
		{
		}
	...
	class mp_slot_upgrade_sc : public BasePacket 
	{
	public:
		uint16_t slot_index{};
	public:
	...
	public:
		mp_slot_upgrade_sc() : BasePacket(mpe_cmd::slot_upgrade_sc)
		{
		}
