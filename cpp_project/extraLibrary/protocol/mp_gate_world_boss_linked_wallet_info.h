...
namespace mir3d
{
	class mp_gate_world_boss_linked_wallet_info_cs : public BasePacket 
	{
	public:
		int64_t auid{};	// 계정 아이디
	public:
	...
	public:
		mp_gate_world_boss_linked_wallet_info_cs() : BasePacket(mpe_cmd::gate_world_boss_linked_wallet_info_cs)
		{
		}
	...
	class mp_gate_world_boss_linked_wallet_info_sc : public BasePacket 
	{
	public:
	...
	public:
		mp_gate_world_boss_linked_wallet_info_sc() : BasePacket(mpe_cmd::gate_world_boss_linked_wallet_info_sc)
		{
		}
