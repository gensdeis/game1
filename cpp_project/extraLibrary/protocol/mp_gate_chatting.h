...
namespace mir3d
{
	class mp_gate_chatting_cs : public BasePacket 	// 채팅
	{
	public:
		mpe_chatting type{};
	public:
	...
	public:
		std::string link{};
	public:
		int64_t recv_uid{};	// "수신자uid. 길드동맹때문에 추가함."

	public:
		mp_gate_chatting_cs() : BasePacket(mpe_cmd::gate_chatting_cs)
		{
		}
	...
	class mp_gate_chatting_sc : public BasePacket 	// 채팅
	{
	public:
	...
	public:
		mp_gate_chatting_sc() : BasePacket(mpe_cmd::gate_chatting_sc)
		{
		}
