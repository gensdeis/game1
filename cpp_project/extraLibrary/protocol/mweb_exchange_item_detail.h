...
namespace mir3d
{
	class mweb_exchange_item_detail_cs : public WebBasePacket 
	{
	public:
	...
	public:
		mweb_exchange_item_detail_cs() : WebBasePacket()
		{
		}
	...
	class mweb_exchange_item_detail_sc : public WebBasePacket 
	{
	private:
	...
	public:
		mweb_exchange_item_detail_sc() : WebBasePacket()
		{
		}
