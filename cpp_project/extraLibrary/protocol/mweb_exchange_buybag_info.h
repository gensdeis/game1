...
namespace mir3d
{
	class mweb_exchange_buybag_info_cs : public WebBasePacket 
	{
	public:
		int64_t cuid{};

	public:
		mweb_exchange_buybag_info_cs() : WebBasePacket()
		{
		}
	...
	class mweb_exchange_buybag_info_sc : public WebBasePacket 
	{
	private:
	...
	public:
		mweb_exchange_buybag_info_sc() : WebBasePacket()
		{
		}
