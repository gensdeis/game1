...
namespace mir3d
{
	class mrpc_restore_item_cs : public RpcPacket 	// 강화 실패 아이템 복구
	{
	public:
		int64_t ruid{};	// 복구할 정보
	public:
	...
	public:
		mrpc_restore_item_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::restore_item_cs, tag)
		{
		}
		mrpc_restore_item_cs() : RpcPacket(mpe_rpc_cmd::restore_item_cs)
		{
		}
	...
	class mrpc_restore_item_sc : public RpcPacket 	// 강화 실패 아이템 복구
	{
	public:
		int64_t key{};

	public:
		mrpc_restore_item_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::restore_item_sc, tag)
		{
		}
		mrpc_restore_item_sc() : RpcPacket(mpe_rpc_cmd::restore_item_sc)
		{
		}
