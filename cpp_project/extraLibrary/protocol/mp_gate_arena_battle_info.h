...
namespace mir3d
{
	class mp_gate_arena_battle_info_cs : public BasePacket 
	{
	public:
		int64_t cuid{};
	public:
	...
	public:
		mp_gate_arena_battle_info_cs() : BasePacket(mpe_cmd::gate_arena_battle_info_cs)
		{
		}
	...
	class mp_gate_arena_battle_info_sc : public BasePacket 
	{
	public:
	...
	public:
		mp_gate_arena_battle_info_sc() : BasePacket(mpe_cmd::gate_arena_battle_info_sc)
		{
		}
