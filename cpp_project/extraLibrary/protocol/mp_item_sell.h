...
namespace mir3d
{
	class mp_item_sell_cs : public BasePacket 
	{
	public:
		int64_t nuid{};	// [default = equip];
	private:
	...
	public:
		mp_item_sell_cs() : BasePacket(mpe_cmd::item_sell_cs)
		{
		}
	...
	class mp_item_sell_sc : public BasePacket 
	{
	public:
		float weight{};
	private:
		bool flag_info = false;
		mps_item_add info;	// 변경된 재화
	...
	public:
		mp_item_sell_sc() : BasePacket(mpe_cmd::item_sell_sc)
		{
		}
