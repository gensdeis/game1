...
namespace mir3d
{
	class mrpc_achieve_reward_cs : public RpcPacket 
	{
	public:
		int64_t key{};
	public:
		int64_t cuid{};
	public:
		std::vector<mps_achieve_info> achieve_info{};
	public:
		std::vector<mps_title_info> title_info{};
	private:
	...
	public:
		mrpc_achieve_reward_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::achieve_reward_cs, tag)
		{
		}
		mrpc_achieve_reward_cs() : RpcPacket(mpe_rpc_cmd::achieve_reward_cs)
		{
		}
	...
	class mrpc_achieve_reward_sc : public RpcPacket 
	{
	public:
		int64_t key{};

	public:
		mrpc_achieve_reward_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::achieve_reward_sc, tag)
		{
		}
		mrpc_achieve_reward_sc() : RpcPacket(mpe_rpc_cmd::achieve_reward_sc)
		{
		}
