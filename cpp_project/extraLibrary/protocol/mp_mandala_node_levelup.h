...
namespace mir3d
{
	class mp_mandala_node_levelup_cs : public BasePacket 
	{
	public:
		int32_t node_id{};
	public:
	...
	public:
		mp_mandala_node_levelup_cs() : BasePacket(mpe_cmd::mandala_node_levelup_cs)
		{
		}
	...
	class mp_mandala_node_levelup_sc : public BasePacket 
	{
	private:
	...
	public:
		mpe_upgrade_state upgrade_result{};
	public:
		mpe_mandala_type mandala_type{};	// 만다라 타입(1:전투2:장인3:시즌)

	public:
		mp_mandala_node_levelup_sc() : BasePacket(mpe_cmd::mandala_node_levelup_sc)
		{
		}
