...
namespace mir3d
{
	class mweb_gm_occupationwar_all_info_cs : public WebBasePacket 
	{

	public:
		mweb_gm_occupationwar_all_info_cs() : WebBasePacket()
		{
		}
	...
	class mweb_gm_occupationwar_all_info_sc : public WebBasePacket 
	{
	private:
	...
	public:
		mweb_gm_occupationwar_all_info_sc() : WebBasePacket()
		{
		}
