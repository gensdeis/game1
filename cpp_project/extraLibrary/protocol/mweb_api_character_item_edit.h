...
namespace mir3d
{
	class mweb_api_character_item_edit_cs : public WebBasePacket 
	{
	public:
		int64_t cuid{};
	private:
	...
	public:
		mweb_api_character_item_edit_cs() : WebBasePacket()
		{
		}
	...
	class mweb_api_character_item_edit_sc : public WebBasePacket 
	{
	public:
		mpe_error result{};

	public:
		mweb_api_character_item_edit_sc() : WebBasePacket()
		{
		}
