...
namespace mir3d
{
	class mweb_exchange_marketprice_cs : public WebBasePacket 
	{
	public:
		uint16_t id{};

	public:
		mweb_exchange_marketprice_cs() : WebBasePacket()
		{
		}
	...
	class mweb_exchange_marketprice_sc : public WebBasePacket 
	{
	private:
	...
	public:
		mweb_exchange_marketprice_sc() : WebBasePacket()
		{
		}
