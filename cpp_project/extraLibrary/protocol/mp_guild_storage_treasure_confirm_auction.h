...
namespace mir3d
{
	class mp_guild_storage_treasure_confirm_auction_cs : public BasePacket 	// 문파 보물 창고 경매 종료 확인
	{
	public:
		int64_t auction_uid{};

	public:
		mp_guild_storage_treasure_confirm_auction_cs() : BasePacket(mpe_cmd::guild_storage_treasure_confirm_auction_cs)
		{
		}
	...
	class mp_guild_storage_treasure_confirm_auction_sc : public BasePacket 	// 문파 보물 창고 경매 종료 확인
	{
	private:
	...
	public:
		mp_guild_storage_treasure_confirm_auction_sc() : BasePacket(mpe_cmd::guild_storage_treasure_confirm_auction_sc)
		{
		}
