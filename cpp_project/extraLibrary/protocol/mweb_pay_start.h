...
namespace mir3d
{
	class mweb_pay_start_cs : public WebBasePacket 
	{
	public:
	...
	public:
		mweb_pay_start_cs() : WebBasePacket()
		{
		}
	...
	class mweb_pay_start_sc : public WebBasePacket 
	{
	public:
		int32_t code{};
	public:
	...
	public:
		mweb_pay_start_sc() : WebBasePacket()
		{
		}
