...
namespace mir3d
{
	class mp_customizing_save_cs : public BasePacket 
	{
	public:
		uint16_t gender{};	// table::gender_type
	public:
		uint16_t customizing_data{};

	public:
		mp_customizing_save_cs() : BasePacket(mpe_cmd::customizing_save_cs)
		{
		}
	...
	class mp_customizing_save_sc : public BasePacket 
	{
	public:
		uint16_t customizing_data{};
	private:
	...
	public:
		mp_customizing_save_sc() : BasePacket(mpe_cmd::customizing_save_sc)
		{
		}
