...
namespace mir3d
{
	class mp_party_setup_cs : public BasePacket 
	{
	private:
	...
	public:
		mp_party_setup_cs() : BasePacket(mpe_cmd::party_setup_cs)
		{
		}
	...
	class mp_party_setup_sc : public BasePacket 
	{
	private:
		bool flag_info = false;
		mps_party_info info;	// "파티정보로변경. 멤버목록, is_ready 전달을 위해 수정됨"
	...
	public:
		mp_party_setup_sc() : BasePacket(mpe_cmd::party_setup_sc)
		{
		}
