...
namespace mir3d
{
	class mrpc_gate_dogma_pay_end_cs : public RpcPacket 	// 도그마 상점 트랜잭션 마무리
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_gate_dogma_pay_end_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::gate_dogma_pay_end_cs, tag)
		{
		}
		mrpc_gate_dogma_pay_end_cs() : RpcPacket(mpe_rpc_cmd::gate_dogma_pay_end_cs)
		{
		}
	...
	class mrpc_gate_dogma_pay_end_sc : public RpcPacket 	// 도그마 상점 트랜잭션 마무리
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_gate_dogma_pay_end_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::gate_dogma_pay_end_sc, tag)
		{
		}
		mrpc_gate_dogma_pay_end_sc() : RpcPacket(mpe_rpc_cmd::gate_dogma_pay_end_sc)
		{
		}
