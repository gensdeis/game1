...
namespace mir3d
{
	class mrpc_guild_buff_buy_cs : public RpcPacket 
	{
	public:
		int64_t cuid{};
	public:
	...
	public:
		mrpc_guild_buff_buy_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::guild_buff_buy_cs, tag)
		{
		}
		mrpc_guild_buff_buy_cs() : RpcPacket(mpe_rpc_cmd::guild_buff_buy_cs)
		{
		}
	...
	public:
		template<typename T_BUFFER> void Serialize(T_BUFFER* pBuffer)
		{
			...
			protocol::SerializeType(pBuffer, &guild_skill_id);
	...
	class mrpc_guild_buff_buy_sc : public RpcPacket 
	{
	public:
		int64_t cuid{};
	public:
	...
	public:
		mrpc_guild_buff_buy_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::guild_buff_buy_sc, tag)
		{
		}
		mrpc_guild_buff_buy_sc() : RpcPacket(mpe_rpc_cmd::guild_buff_buy_sc)
		{
		}
