...
namespace mir3d
{
	class mp_item_make_cs : public BasePacket 
	{
	public:
		int32_t id{};
	public:
	...
	public:
		mp_item_make_cs() : BasePacket(mpe_cmd::item_make_cs)
		{
		}
	...
	class mp_item_make_sc : public BasePacket 
	{
	public:
		float weight{};
	private:
	...
	public:
		mp_item_make_sc() : BasePacket(mpe_cmd::item_make_sc)
		{
		}
