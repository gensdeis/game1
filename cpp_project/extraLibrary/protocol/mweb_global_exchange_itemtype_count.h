...
namespace mir3d
{
	class mweb_global_exchange_itemtype_count_cs : public WebBasePacket 
	{
	public:
	...
	public:
		mweb_global_exchange_itemtype_count_cs() : WebBasePacket()
		{
		}
	...
	class mweb_global_exchange_itemtype_count_sc : public WebBasePacket 
	{
	private:
	...
	public:
		mweb_global_exchange_itemtype_count_sc() : WebBasePacket()
		{
		}
