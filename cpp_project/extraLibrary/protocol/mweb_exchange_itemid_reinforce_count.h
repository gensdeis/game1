...
namespace mir3d
{
	class mweb_exchange_itemid_reinforce_count_cs : public WebBasePacket 
	{
	public:
	...
	public:
		mweb_exchange_itemid_reinforce_count_cs() : WebBasePacket()
		{
		}
	...
	class mweb_exchange_itemid_reinforce_count_sc : public WebBasePacket 
	{
	private:
	...
	public:
		mweb_exchange_itemid_reinforce_count_sc() : WebBasePacket()
		{
		}
