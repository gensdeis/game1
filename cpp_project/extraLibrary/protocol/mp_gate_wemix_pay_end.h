...
namespace mir3d
{
	class mp_gate_wemix_pay_end_cs : public BasePacket 	// 위믹스 상점 트랜잭션 마무리
	{
	public:
	...
	public:
		mp_gate_wemix_pay_end_cs() : BasePacket(mpe_cmd::gate_wemix_pay_end_cs)
		{
		}
	...
	class mp_gate_wemix_pay_end_sc : public BasePacket 	// 위믹스 상점 트랜잭션 마무리
	{
	public:
		int32_t result{};
	public:
	...
	public:
		mp_gate_wemix_pay_end_sc() : BasePacket(mpe_cmd::gate_wemix_pay_end_sc)
		{
		}
