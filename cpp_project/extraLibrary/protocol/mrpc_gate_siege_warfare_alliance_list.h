...
namespace mir3d
{
	class mrpc_gate_siege_warfare_alliance_list_cs : public RpcPacket 	// 연합 리스트 정보
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_gate_siege_warfare_alliance_list_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::gate_siege_warfare_alliance_list_cs, tag)
		{
		}
		mrpc_gate_siege_warfare_alliance_list_cs() : RpcPacket(mpe_rpc_cmd::gate_siege_warfare_alliance_list_cs)
		{
		}
	...
	class mrpc_gate_siege_warfare_alliance_list_sc : public RpcPacket 	// 연합 리스트 정보
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_gate_siege_warfare_alliance_list_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::gate_siege_warfare_alliance_list_sc, tag)
		{
		}
		mrpc_gate_siege_warfare_alliance_list_sc() : RpcPacket(mpe_rpc_cmd::gate_siege_warfare_alliance_list_sc)
		{
		}
