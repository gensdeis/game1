...
namespace mir3d
{
	class mp_ai_setup_config_info_cs : public BasePacket 
	{

	public:
		mp_ai_setup_config_info_cs() : BasePacket(mpe_cmd::ai_setup_config_info_cs)
		{
		}
	...
	class mp_ai_setup_config_info_sc : public BasePacket 
	{
	private:
	...
	public:
		mp_ai_setup_config_info_sc() : BasePacket(mpe_cmd::ai_setup_config_info_sc)
		{
		}
