...
namespace mir3d
{
	class mrpc_mandala_node_add_cs : public RpcPacket 
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_mandala_node_add_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::mandala_node_add_cs, tag)
		{
		}
		mrpc_mandala_node_add_cs() : RpcPacket(mpe_rpc_cmd::mandala_node_add_cs)
		{
		}
	...
	class mrpc_mandala_node_add_sc : public RpcPacket 
	{
	public:
		int64_t key{};

	public:
		mrpc_mandala_node_add_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::mandala_node_add_sc, tag)
		{
		}
		mrpc_mandala_node_add_sc() : RpcPacket(mpe_rpc_cmd::mandala_node_add_sc)
		{
		}
