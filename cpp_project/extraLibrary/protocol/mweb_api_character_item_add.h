...
namespace mir3d
{
	class mweb_api_character_item_add_cs : public WebBasePacket 
	{
	public:
		int64_t cuid{};
	private:
	...
	public:
		mweb_api_character_item_add_cs() : WebBasePacket()
		{
		}
	...
	class mweb_api_character_item_add_sc : public WebBasePacket 
	{
	public:
		mpe_error result{};

	public:
		mweb_api_character_item_add_sc() : WebBasePacket()
		{
		}
