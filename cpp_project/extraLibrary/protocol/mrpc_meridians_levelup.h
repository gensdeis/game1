...
namespace mir3d
{
	class mrpc_meridians_levelup_cs : public RpcPacket 
	{
	public:
		int64_t key{};
	public:
	...
	public:
		std::string skill_slot{};

	public:
		mrpc_meridians_levelup_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::meridians_levelup_cs, tag)
		{
		}
		mrpc_meridians_levelup_cs() : RpcPacket(mpe_rpc_cmd::meridians_levelup_cs)
		{
		}
	...
	class mrpc_meridians_levelup_sc : public RpcPacket 
	{
	public:
		int64_t key{};

	public:
		mrpc_meridians_levelup_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::meridians_levelup_sc, tag)
		{
		}
		mrpc_meridians_levelup_sc() : RpcPacket(mpe_rpc_cmd::meridians_levelup_sc)
		{
		}
