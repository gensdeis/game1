...
namespace mir3d
{
	class mp_temp_reflection_change_cs : public BasePacket 
	{
	public:
		int64_t temp_uid{};

	public:
		mp_temp_reflection_change_cs() : BasePacket(mpe_cmd::temp_reflection_change_cs)
		{
		}
	...
	class mp_temp_reflection_change_sc : public BasePacket 
	{
	private:
	...
	public:
		mp_temp_reflection_change_sc() : BasePacket(mpe_cmd::temp_reflection_change_sc)
		{
		}
