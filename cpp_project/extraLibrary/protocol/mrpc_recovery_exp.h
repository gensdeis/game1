...
namespace mir3d
{
	class mrpc_recovery_exp_cs : public RpcPacket 
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_recovery_exp_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::recovery_exp_cs, tag)
		{
		}
		mrpc_recovery_exp_cs() : RpcPacket(mpe_rpc_cmd::recovery_exp_cs)
		{
		}
	...
	class mrpc_recovery_exp_sc : public RpcPacket 
	{
	public:
		int64_t key{};

	public:
		mrpc_recovery_exp_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::recovery_exp_sc, tag)
		{
		}
		mrpc_recovery_exp_sc() : RpcPacket(mpe_rpc_cmd::recovery_exp_sc)
		{
		}
