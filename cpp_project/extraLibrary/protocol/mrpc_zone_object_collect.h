...
namespace mir3d
{
	class mrpc_zone_object_collect_cs : public RpcPacket 
	{
	public:
		int64_t key{};
	public:
	...
	private:
		...
		mps_gameitem_update info;	// 아이템 정보
	...
	public:
		mrpc_zone_object_collect_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::zone_object_collect_cs, tag)
		{
		}
		mrpc_zone_object_collect_cs() : RpcPacket(mpe_rpc_cmd::zone_object_collect_cs)
		{
		}
	...
	class mrpc_zone_object_collect_sc : public RpcPacket 
	{
	public:
		int64_t key{};

	public:
		mrpc_zone_object_collect_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::zone_object_collect_sc, tag)
		{
		}
		mrpc_zone_object_collect_sc() : RpcPacket(mpe_rpc_cmd::zone_object_collect_sc)
		{
		}
