...
namespace mir3d
{
	class mp_zone_teleport_to_saved_area_cs : public BasePacket 	// 텔레포트 좌표이동
	{
	public:
		int32_t map_id{};
	public:
	...
	public:
		mp_zone_teleport_to_saved_area_cs() : BasePacket(mpe_cmd::zone_teleport_to_saved_area_cs)
		{
		}
	...
	class mp_zone_teleport_to_saved_area_sc : public BasePacket 	// 텔레포트 좌표이동
	{
	public:
		int32_t map_id{};
	private:
	...
	public:
		mp_zone_teleport_to_saved_area_sc() : BasePacket(mpe_cmd::zone_teleport_to_saved_area_sc)
		{
		}
