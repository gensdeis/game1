...
namespace mir3d
{
	class mweb_game_option_select_cs : public WebBasePacket 
	{
	public:
		int64_t cuid{};
	public:
	...
	public:
		mweb_game_option_select_cs() : WebBasePacket()
		{
		}
	...
	class mweb_game_option_select_sc : public WebBasePacket 
	{
	private:
	...
	public:
		mweb_game_option_select_sc() : WebBasePacket()
		{
		}
