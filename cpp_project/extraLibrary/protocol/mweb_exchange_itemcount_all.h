...
namespace mir3d
{
	class mweb_exchange_itemcount_all_cs : public WebBasePacket 
	{

	public:
		mweb_exchange_itemcount_all_cs() : WebBasePacket()
		{
		}
	...
	class mweb_exchange_itemcount_all_sc : public WebBasePacket 
	{
	private:
	...
	public:
		mweb_exchange_itemcount_all_sc() : WebBasePacket()
		{
		}
