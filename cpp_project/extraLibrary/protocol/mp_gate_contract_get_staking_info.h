...
namespace mir3d
{
	class mp_gate_contract_get_staking_info_cs : public BasePacket 	// 스테이킹 관련 정보 조회
	{
	public:
		int64_t auid{};
	public:
	...
	public:
		mp_gate_contract_get_staking_info_cs() : BasePacket(mpe_cmd::gate_contract_get_staking_info_cs)
		{
		}
	...
	class mp_gate_contract_get_staking_info_sc : public BasePacket 	// 스테이킹 관련 정보 조회
	{
	public:
	...
	public:
		mp_gate_contract_get_staking_info_sc() : BasePacket(mpe_cmd::gate_contract_get_staking_info_sc)
		{
		}
