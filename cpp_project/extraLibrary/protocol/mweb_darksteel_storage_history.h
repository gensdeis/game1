...
namespace mir3d
{
	class mweb_darksteel_storage_history_cs : public WebBasePacket 	// 비곡창고 사용내역
	{
	public:
	...
	public:
		mweb_darksteel_storage_history_cs() : WebBasePacket()
		{
		}
	...
	class mweb_darksteel_storage_history_sc : public WebBasePacket 	// 비곡창고 사용내역
	{
	private:
	...
	public:
		mweb_darksteel_storage_history_sc() : WebBasePacket()
		{
		}
