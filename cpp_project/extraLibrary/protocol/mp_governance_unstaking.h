...
namespace mir3d
{
	class mp_governance_unstaking_cs : public BasePacket 	// 선택된 서버에 코인 언스테이킹
	{
	public:
	...
	public:
		mp_governance_unstaking_cs() : BasePacket(mpe_cmd::governance_unstaking_cs)
		{
		}
	...
	class mp_governance_unstaking_sc : public BasePacket 	// 선택된 서버에 코인 언스테이킹
	{
	public:
	...
	public:
		mp_governance_unstaking_sc() : BasePacket(mpe_cmd::governance_unstaking_sc)
		{
		}
