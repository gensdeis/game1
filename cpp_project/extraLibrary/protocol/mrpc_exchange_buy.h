...
namespace mir3d
{
	class mrpc_exchange_buy_cs : public RpcPacket 
	{
	private:
	...
	public:
		mrpc_exchange_buy_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::exchange_buy_cs, tag)
		{
		}
		mrpc_exchange_buy_cs() : RpcPacket(mpe_rpc_cmd::exchange_buy_cs)
		{
		}
	...
	class mrpc_exchange_buy_sc : public RpcPacket 
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_exchange_buy_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::exchange_buy_sc, tag)
		{
		}
		mrpc_exchange_buy_sc() : RpcPacket(mpe_rpc_cmd::exchange_buy_sc)
		{
		}
