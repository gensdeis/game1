...
namespace mir3d
{
	class mp_guild_join_request_cs : public BasePacket 
	{
	public:
		int64_t guid{};

	public:
		mp_guild_join_request_cs() : BasePacket(mpe_cmd::guild_join_request_cs)
		{
		}
	...
	class mp_guild_join_request_sc : public BasePacket 
	{
	public:
		mpe_error error{};
	public:
	...
	public:
		mp_guild_join_request_sc() : BasePacket(mpe_cmd::guild_join_request_sc)
		{
		}
	...
	public:
		template<typename T_BUFFER> void Serialize(T_BUFFER* pBuffer)
		{
			...
			protocol::SerializeType(pBuffer, &waiting);
