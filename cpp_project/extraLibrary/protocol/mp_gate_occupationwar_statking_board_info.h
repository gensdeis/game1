...
namespace mir3d
{
	class mp_gate_occupationwar_statking_board_info_cs : public BasePacket 
	{
	public:
		mpe_governance_contents_type cotents_type{};	// 거버넌스 콘텐츠 타입(0:없음 1:보스 2:비곡점령전 3:공성전)

	public:
		mp_gate_occupationwar_statking_board_info_cs() : BasePacket(mpe_cmd::gate_occupationwar_statking_board_info_cs)
		{
		}
	...
	class mp_gate_occupationwar_statking_board_info_sc : public BasePacket 
	{
	private:
	...
	public:
		mp_gate_occupationwar_statking_board_info_sc() : BasePacket(mpe_cmd::gate_occupationwar_statking_board_info_sc)
		{
		}
