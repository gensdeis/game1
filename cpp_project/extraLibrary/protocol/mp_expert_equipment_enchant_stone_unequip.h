...
namespace mir3d
{
	class mp_expert_equipment_enchant_stone_unequip_cs : public BasePacket 
	{
	public:
	...
	public:
		mp_expert_equipment_enchant_stone_unequip_cs() : BasePacket(mpe_cmd::expert_equipment_enchant_stone_unequip_cs)
		{
		}
	...
	class mp_expert_equipment_enchant_stone_unequip_sc : public BasePacket 
	{
	private:
		bool flag_expert_equipment_info = false;
		mps_expert_equipment_info expert_equipment_info;	// "용령석 착용 해제 완료된 전직 장비 정보."
	...
	private:
		...
		mps_item_add update_stone_item;	// "착용해제된 용령석 아이템"
	...
	public:
		mp_expert_equipment_enchant_stone_unequip_sc() : BasePacket(mpe_cmd::expert_equipment_enchant_stone_unequip_sc)
		{
		}
