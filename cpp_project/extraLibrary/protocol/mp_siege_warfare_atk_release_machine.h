...
namespace mir3d
{
	class mp_siege_warfare_atk_release_machine_cs : public BasePacket 	// 공성병기 해제
	{
	public:
		int64_t nuid{};
	public:
	...
	public:
		mp_siege_warfare_atk_release_machine_cs() : BasePacket(mpe_cmd::siege_warfare_atk_release_machine_cs)
		{
		}
	...
	class mp_siege_warfare_atk_release_machine_sc : public BasePacket 	// 공성병기 해제
	{

	public:
		mp_siege_warfare_atk_release_machine_sc() : BasePacket(mpe_cmd::siege_warfare_atk_release_machine_sc)
		{
		}
