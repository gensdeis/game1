...
namespace mir3d
{
	class mrpc_guild_storage_supply_get_item_cs : public RpcPacket 	// 문파 보급 창고서 아이템 빼기
	{
	public:
		int64_t cuid{};
	public:
	...
	public:
		bool in_siege_map{};	// //공성전 맵에 있는지 여부

	public:
		mrpc_guild_storage_supply_get_item_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::guild_storage_supply_get_item_cs, tag)
		{
		}
		mrpc_guild_storage_supply_get_item_cs() : RpcPacket(mpe_rpc_cmd::guild_storage_supply_get_item_cs)
		{
		}
	...
	class mrpc_guild_storage_supply_get_item_sc : public RpcPacket 	// 문파 보급 창고서 아이템 빼기
	{
	public:
		int64_t cuid{};
	private:
	...
	public:
		mrpc_guild_storage_supply_get_item_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::guild_storage_supply_get_item_sc, tag)
		{
		}
		mrpc_guild_storage_supply_get_item_sc() : RpcPacket(mpe_rpc_cmd::guild_storage_supply_get_item_sc)
		{
		}
