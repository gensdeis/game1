...
namespace mir3d
{
	class mrpc_exchange_gold_item_cs : public RpcPacket 
	{
	private:
	...
	public:
		mrpc_exchange_gold_item_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::exchange_gold_item_cs, tag)
		{
		}
		mrpc_exchange_gold_item_cs() : RpcPacket(mpe_rpc_cmd::exchange_gold_item_cs)
		{
		}
	...
	class mrpc_exchange_gold_item_sc : public RpcPacket 
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_exchange_gold_item_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::exchange_gold_item_sc, tag)
		{
		}
		mrpc_exchange_gold_item_sc() : RpcPacket(mpe_rpc_cmd::exchange_gold_item_sc)
		{
		}
