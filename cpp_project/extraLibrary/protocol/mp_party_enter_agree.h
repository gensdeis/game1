...
namespace mir3d
{
	class mp_party_enter_agree_cs : public BasePacket 
	{
	public:
		int64_t cuid{};

	public:
		mp_party_enter_agree_cs() : BasePacket(mpe_cmd::party_enter_agree_cs)
		{
		}
	...
	class mp_party_enter_agree_sc : public BasePacket 
	{
	private:
	...
	public:
		mp_party_enter_agree_sc() : BasePacket(mpe_cmd::party_enter_agree_sc)
		{
		}
