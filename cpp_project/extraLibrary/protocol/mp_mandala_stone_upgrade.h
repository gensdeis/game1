...
namespace mir3d
{
	class mp_mandala_stone_upgrade_cs : public BasePacket 
	{
	public:
		int32_t node_id{};
	public:
		int64_t use_uid{};	// 재료로 사용될 용령석uid
	public:
		mpe_mandala_type mandala_type{};	// 만다라 타입(1:전투2:장인3:시즌)

	public:
		mp_mandala_stone_upgrade_cs() : BasePacket(mpe_cmd::mandala_stone_upgrade_cs)
		{
		}
	...
	class mp_mandala_stone_upgrade_sc : public BasePacket 
	{
	private:
	...
	public:
		mpe_item_reinforce_position result{};
	private:
	...
	public:
		mp_mandala_stone_upgrade_sc() : BasePacket(mpe_cmd::mandala_stone_upgrade_sc)
		{
		}
