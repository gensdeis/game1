...
namespace mir3d
{
	class mp_gate_exchange_itemid_reinforce_list_cs : public BasePacket 
	{
	public:
	...
	public:
		mp_gate_exchange_itemid_reinforce_list_cs() : BasePacket(mpe_cmd::gate_exchange_itemid_reinforce_list_cs)
		{
		}
	...
	class mp_gate_exchange_itemid_reinforce_list_sc : public BasePacket 
	{
	public:
	...
	public:
		mp_gate_exchange_itemid_reinforce_list_sc() : BasePacket(mpe_cmd::gate_exchange_itemid_reinforce_list_sc)
		{
		}
