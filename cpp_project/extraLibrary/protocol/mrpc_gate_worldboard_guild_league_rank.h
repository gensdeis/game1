...
namespace mir3d
{
	class mrpc_gate_worldboard_guild_league_rank_cs : public RpcPacket 
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_gate_worldboard_guild_league_rank_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::gate_worldboard_guild_league_rank_cs, tag)
		{
		}
		mrpc_gate_worldboard_guild_league_rank_cs() : RpcPacket(mpe_rpc_cmd::gate_worldboard_guild_league_rank_cs)
		{
		}
	...
	class mrpc_gate_worldboard_guild_league_rank_sc : public RpcPacket 
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_gate_worldboard_guild_league_rank_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::gate_worldboard_guild_league_rank_sc, tag)
		{
		}
		mrpc_gate_worldboard_guild_league_rank_sc() : RpcPacket(mpe_rpc_cmd::gate_worldboard_guild_league_rank_sc)
		{
		}
