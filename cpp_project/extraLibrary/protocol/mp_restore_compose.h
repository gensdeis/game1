...
namespace mir3d
{
	class mp_restore_compose_cs : public BasePacket 	// 합성 실패 복구권 요청
	{
	private:
		bool flag_restore_info = false;
		mps_restore_compose restore_info;	// 복구할 정보
	...
	public:
		mp_restore_compose_cs() : BasePacket(mpe_cmd::restore_compose_cs)
		{
		}
	...
	class mp_restore_compose_sc : public BasePacket 	// 합성 실패 복구권 요청
	{
	private:
	...
	public:
		mp_restore_compose_sc() : BasePacket(mpe_cmd::restore_compose_sc)
		{
		}
