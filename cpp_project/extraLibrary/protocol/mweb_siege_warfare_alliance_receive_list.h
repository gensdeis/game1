...
namespace mir3d
{
	class mweb_siege_warfare_alliance_receive_list_cs : public WebBasePacket 	// 연합 리스트 정보 (요청받은길드용)
	{
	public:
		int64_t guid{};
	public:
	...
	public:
		mweb_siege_warfare_alliance_receive_list_cs() : WebBasePacket()
		{
		}
	...
	class mweb_siege_warfare_alliance_receive_list_sc : public WebBasePacket 	// 연합 리스트 정보 (요청받은길드용)
	{
	public:
	...
	public:
		mweb_siege_warfare_alliance_receive_list_sc() : WebBasePacket()
		{
		}
