...
namespace mir3d
{
	class mp_guild_register_master_order_quest_cs : public BasePacket 
	{
	public:
		int32_t quest_tid{};

	public:
		mp_guild_register_master_order_quest_cs() : BasePacket(mpe_cmd::guild_register_master_order_quest_cs)
		{
		}
	...
	class mp_guild_register_master_order_quest_sc : public BasePacket 
	{
	private:
	...
	public:
		mp_guild_register_master_order_quest_sc() : BasePacket(mpe_cmd::guild_register_master_order_quest_sc)
		{
		}
