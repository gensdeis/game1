...
namespace mir3d
{
	class mp_zone_sector_teleport_cs : public BasePacket 
	{
	public:
		int32_t index{};

	public:
		mp_zone_sector_teleport_cs() : BasePacket(mpe_cmd::zone_sector_teleport_cs)
		{
		}
	...
	class mp_zone_sector_teleport_sc : public BasePacket 
	{
	public:
		int32_t zone_id{};
	private:
	...
	public:
		mp_zone_sector_teleport_sc() : BasePacket(mpe_cmd::zone_sector_teleport_sc)
		{
		}
