...
namespace mir3d
{
	class mp_gate_cash_shop_info_cs : public BasePacket 
	{
	public:
		int64_t auid{};
	public:
	...
	public:
		mp_gate_cash_shop_info_cs() : BasePacket(mpe_cmd::gate_cash_shop_info_cs)
		{
		}
	...
	class mp_gate_cash_shop_info_sc : public BasePacket 
	{
	public:
	...
	public:
		mp_gate_cash_shop_info_sc() : BasePacket(mpe_cmd::gate_cash_shop_info_sc)
		{
		}
