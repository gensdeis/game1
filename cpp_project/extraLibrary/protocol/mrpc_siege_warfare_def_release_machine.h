...
namespace mir3d
{
	class mrpc_siege_warfare_def_release_machine_cs : public RpcPacket 	// 수성병기 해제
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_siege_warfare_def_release_machine_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::siege_warfare_def_release_machine_cs, tag)
		{
		}
		mrpc_siege_warfare_def_release_machine_cs() : RpcPacket(mpe_rpc_cmd::siege_warfare_def_release_machine_cs)
		{
		}
	...
	class mrpc_siege_warfare_def_release_machine_sc : public RpcPacket 	// 수성병기 해제
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_siege_warfare_def_release_machine_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::siege_warfare_def_release_machine_sc, tag)
		{
		}
		mrpc_siege_warfare_def_release_machine_sc() : RpcPacket(mpe_rpc_cmd::siege_warfare_def_release_machine_sc)
		{
		}
