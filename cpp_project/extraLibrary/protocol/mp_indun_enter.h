...
namespace mir3d
{
	class mp_indun_enter_cs : public BasePacket 	// indun
	{
	public:
		int32_t id{};

	public:
		mp_indun_enter_cs() : BasePacket(mpe_cmd::indun_enter_cs)
		{
		}
	...
	class mp_indun_enter_sc : public BasePacket 	// indun
	{
	public:
		mpe_error result{};
	public:
	...
	public:
		mp_indun_enter_sc() : BasePacket(mpe_cmd::indun_enter_sc)
		{
		}
