...
namespace mir3d
{
	class mweb_global_exchange_itemid_lists_cs : public WebBasePacket 
	{
	public:
	...
	public:
		mweb_global_exchange_itemid_lists_cs() : WebBasePacket()
		{
		}
	...
	class mweb_global_exchange_itemid_lists_sc : public WebBasePacket 
	{
	public:
	...
	public:
		mweb_global_exchange_itemid_lists_sc() : WebBasePacket()
		{
		}
