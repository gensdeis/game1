...
namespace mir3d
{
	class mrpc_item_repair_cs : public RpcPacket 
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_item_repair_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::item_repair_cs, tag)
		{
		}
		mrpc_item_repair_cs() : RpcPacket(mpe_rpc_cmd::item_repair_cs)
		{
		}
	...
	class mrpc_item_repair_sc : public RpcPacket 
	{
	public:
		int64_t key{};

	public:
		mrpc_item_repair_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::item_repair_sc, tag)
		{
		}
		mrpc_item_repair_sc() : RpcPacket(mpe_rpc_cmd::item_repair_sc)
		{
		}
