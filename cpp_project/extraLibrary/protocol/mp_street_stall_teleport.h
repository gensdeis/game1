...
namespace mir3d
{
	class mp_street_stall_teleport_cs : public BasePacket 
	{
	public:
		int32_t map_id{};
	public:
		uint16_t channel_id{};
	public:
		int32_t map_position_id{};

	public:
		mp_street_stall_teleport_cs() : BasePacket(mpe_cmd::street_stall_teleport_cs)
		{
		}
	...
	public:
		template<typename T_BUFFER> void Serialize(T_BUFFER* pBuffer)
		{
			...
			protocol::SerializeType(pBuffer, &map_position_id);
		}
	...
	class mp_street_stall_teleport_sc : public BasePacket 
	{
	public:
		int32_t map_id{};
	private:
	...
	public:
		mp_street_stall_teleport_sc() : BasePacket(mpe_cmd::street_stall_teleport_sc)
		{
		}
