...
namespace mir3d
{
	class mrpc_ai_setup_config_select_cs : public RpcPacket 
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_ai_setup_config_select_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::ai_setup_config_select_cs, tag)
		{
		}
		mrpc_ai_setup_config_select_cs() : RpcPacket(mpe_rpc_cmd::ai_setup_config_select_cs)
		{
		}
	...
	class mrpc_ai_setup_config_select_sc : public RpcPacket 
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_ai_setup_config_select_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::ai_setup_config_select_sc, tag)
		{
		}
		mrpc_ai_setup_config_select_sc() : RpcPacket(mpe_rpc_cmd::ai_setup_config_select_sc)
		{
		}
