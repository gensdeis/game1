...
namespace mir3d
{
	class mp_guild_info_cs : public BasePacket 
	{
	public:
		int64_t guid{};

	public:
		mp_guild_info_cs() : BasePacket(mpe_cmd::guild_info_cs)
		{
		}
	...
	class mp_guild_info_sc : public BasePacket 
	{
	private:
	...
	private:
		...
		mps_guild_member master_info;	// "문파장 정보. 채팅 랭킹등에서 필요. 문파원메뉴 보기 전까지 채워지지 않아서 이슈."
	...
	private:
		...
		mps_guild_member submaster_info;	// "부문주 정보. 채팅 랭킹등에서 필요. 문파원메뉴 보기 전까지 채워지지 않아서 이슈."
	...
	public:
		mp_guild_info_sc() : BasePacket(mpe_cmd::guild_info_sc)
		{
		}
