...
namespace mir3d
{
	class mrpc_pet_feed_cs : public RpcPacket 	// 펫 먹이 사용
	{
	public:
		int64_t key{};
	public:
	...
	public:
		mrpc_pet_feed_cs(uint8_t tag) : RpcPacket(mpe_rpc_cmd::pet_feed_cs, tag)
		{
		}
		mrpc_pet_feed_cs() : RpcPacket(mpe_rpc_cmd::pet_feed_cs)
		{
		}
	...
	class mrpc_pet_feed_sc : public RpcPacket 	// 펫 먹이 사용
	{
	public:
		int64_t key{};

	public:
		mrpc_pet_feed_sc(uint8_t tag) : RpcPacket(mpe_rpc_cmd::pet_feed_sc, tag)
		{
		}
		mrpc_pet_feed_sc() : RpcPacket(mpe_rpc_cmd::pet_feed_sc)
		{
		}
