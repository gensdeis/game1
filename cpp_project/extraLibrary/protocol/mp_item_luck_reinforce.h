...
namespace mir3d
{
	class mp_item_luck_reinforce_cs : public BasePacket 
	{
	public:
		int64_t iuid{};
	public:
	...
	public:
		mp_item_luck_reinforce_cs() : BasePacket(mpe_cmd::item_luck_reinforce_cs)
		{
		}
	...
	class mp_item_luck_reinforce_sc : public BasePacket 
	{
	public:
	...
	public:
		mp_item_luck_reinforce_sc() : BasePacket(mpe_cmd::item_luck_reinforce_sc)
		{
		}
